...
<div class="row g-3">
        ...
        <div class="glass-card mb-3">
            <div class="d-flex justify-content-between align-items-start gap-3">
                ...
                <div class="d-flex gap-2 flex-wrap justify-content-end">
                    <a class="btn btn-success btn-sm" target="_blank" href="<?= e($whatsapp) ?>">WhatsApp</a>
                    <a class="btn btn-outline-dark btn-sm" target="_blank" href="<?= e($consulta) ?>">Portal</a>
                    <a class="btn btn-outline-dark btn-sm" href="<?= e(url('/ordenes/' . $orden['id'] . '/imprimir')) ?>">Imprimir</a>
                </div>
            </div>
            <hr>
            <div class="row g-3">
        ...
        <div class="glass-card mb-3">
            ...
            <?php else: ?>
                <form method="post" action="<?= e(url('/diagnosticos')) ?>">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Diagnostico interno</label><textarea class="form-control" name="diagnostico_tecnico" required></textarea></div>
                        <div class="col-md-6"><label class="form-label">Diagnostico visible</label><textarea class="form-control" name="diagnostico_cliente"></textarea></div>
                        <div class="col-md-4"><label class="form-label">Causa probable</label><input class="form-control" name="causa_probable"></div>
                        <div class="col-md-4"><label class="form-label">Mano de obra</label><input class="form-control" type="number" step="0.01" name="costo_mano_obra" value="0"></div>
                        <div class="col-md-4"><label class="form-label">Refacciones</label><input class="form-control" type="number" step="0.01" name="costo_refacciones" value="0"></div>
                    </div>
                    <button class="btn btn-primary mt-3">Guardar diagnostico</button>
                </form>
            <?php endif; ?>
        </div>
            ...
            <?php if ($cotizacion): ?>
                ...
                <?php if ($cotizacion['estado'] === 'pendiente'): ?>
                    <div class="d-flex gap-2 mt-3">
                        <form method="post" action="<?= e(url('/cotizaciones/' . $cotizacion['id'] . '/autorizar')) ?>"><?= csrf_field() ?><input type="hidden" name="estado" value="aceptada"><button class="btn btn-success btn-sm">Autorizar manual</button></form>
                        <form method="post" action="<?= e(url('/cotizaciones/' . $cotizacion['id'] . '/autorizar')) ?>"><?= csrf_field() ?><input type="hidden" name="estado" value="rechazada"><button class="btn btn-outline-danger btn-sm">Rechazar manual</button></form>
                    </div>
                <?php endif; ?>
            <?php else: ?>
                <form method="post" action="<?= e(url('/cotizaciones')) ?>">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-5"><label class="form-label">Descripcion</label><input class="form-control" name="descripcion" required></div>
                        <div class="col-md-2"><label class="form-label">Cantidad</label><input class="form-control" type="number" step="0.01" name="cantidad" value="1"></div>
                        <div class="col-md-2"><label class="form-label">Precio</label><input class="form-control" type="number" step="0.01" name="precio_unitario" value="<?= e($diagnostico['costo_total_sugerido'] ?? 0) ?>"></div>
                        <div class="col-md-3"><label class="form-label">Descuento</label><input class="form-control" type="number" step="0.01" name="descuento" value="0"></div>
                        <div class="col-md-3"><label class="form-label">IVA</label><input class="form-control" type="number" step="0.01" name="iva" value="0"></div>
                        <div class="col-md-3"><label class="form-label">Vigencia</label><input class="form-control" type="date" name="vigencia"></div>
                        <div class="col-md-12"><label class="form-label">Terminos</label><textarea class="form-control" name="terminos"></textarea></div>
                    </div>
                    <button class="btn btn-primary mt-3">Generar cotizacion</button>
                </form>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="col-xl-4">
        <div class="glass-card mb-3">
            <h2 class="h5">Acciones rapidas</h2>
            ...
            <form method="post" action="<?= e(url('/ordenes/' . $orden['id'] . '/tecnico')) ?>">
                <?= csrf_field() ?>
                <label class="form-label">Asignar tecnico</label>
                <div class="input-group">
                    ...
                    <button class="btn btn-outline-dark">Asignar</button>
                </div>
            </form>
        </div>
        ...
        <div class="glass-card mb-3">
            ...
            <form method="post" action="<?= e(url('/pagos')) ?>">
                ...
                <input class="form-control mb-2" type="number" step="0.01" name="monto" required>
