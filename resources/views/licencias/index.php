<?php
$badge = $estado['activo']
    ? ($estado['vencida'] ? 'text-bg-danger' : 'text-bg-success')
    : 'text-bg-secondary';
?>
<div class="row g-3">
    <div class="col-lg-5">
        <div class="glass-card h-100">
            <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                ...
                <span class="badge <?= e($badge) ?>"><?= $estado['activo'] ? ($estado['vencida'] ? 'Vencida' : 'Activa') : 'Desactivada' ?></span>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check form-switch mt-2">
                            ...
                            <label class="form-check-label" for="demo_activo">Activo</label>
                        </div>
                    </div>
                    <div class="col-12">
