    ...
    <div class="col-lg-4">
        <div class="glass-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h2 class="h5"><?= e($cliente['nombre_completo']) ?></h2>
                    <p class="text-muted mb-2"><?= e($cliente['telefono']) ?> · <?= e($cliente['email'] ?: 'sin email') ?></p>
                </div>
                <a class="btn btn-outline-dark btn-sm" href="<?= e(url('/clientes/' . $cliente['id'] . '/edit')) ?>">Editar</a>
            </div>
            <dl class="mb-0">
            ...
            <div class="d-grid gap-2 mt-3">
                <a class="btn btn-primary" href="<?= e(url('/equipos/create?cliente_id=' . $cliente['id'])) ?>">Registrar equipo</a>
                <a class="btn btn-outline-dark" href="<?= e(url('/ordenes/create')) ?>">Nueva orden</a>
            </div>
        </div>
    </div>
    <div class="col-lg-8">
        <div class="glass-card">
            <h2 class="h5">Historial de reparaciones</h2>
