...
FROM (
    ...
    UNION SELECT 'inventario' UNION SELECT 'proveedores' UNION SELECT 'pagos' UNION SELECT 'garantias'
...
('ordenes.garantia_default', '30 dias sobre la reparacion realizada', 'string', 'ordenes'),
