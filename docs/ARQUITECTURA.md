...
database/              schema.sql, seed_roles_demo.sql, seed_configuracion_base.sql, seed_catalogos_base.sql y seed_demo_data.sql
...
- `seed_roles_demo.sql` — roles, permisos y usuarios demo.
- `seed_configuracion_base.sql` — garantias, politicas, terminos, plantillas,
  datos del negocio, moneda, zona horaria, IVA, licencia demo y otros valores
  operativos de `configuraciones`.
